...
CSF::createSection( $prefix, array(
		...
		'fields' => array(
			...
			array(
				...
				'type'    => 'upload',
				'default' => 'https://wpvideobaker.com/wp-content/uploads/2022/12/Untitled-design.png',
				'preview' => true,
			),
			array(
				...
				'type'    => 'upload',
				'default' => 'https://wpvideobaker.com/wp-content/uploads/2022/12/blcakwhite-5.png',
				'preview' => true,
			),
			array(
				'id'      => 'only_text_bg',
				'title'   => esc_html__( 'Only text / Without Image Background', 'video_baker' ),
				'default' => 'https://wpvideobaker.com/wp-content/uploads/2022/12/blcakwhite-4.png',
				'type'    => 'upload',
				'preview' => true,
			),
			 array(
